...
1. Search for **IoT Hub (1)** and select **IoT Hub (2)**.
...
1. Search for **Storage account (1)** and select **Storage account (2)** from the services.
...
1. Search for **Stream Analytics (1)** and select **Stream Analytics jobs (2)**.
